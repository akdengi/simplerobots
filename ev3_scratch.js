...
var warnedAboutBattery = warnedAboutBattery || true;
...
var colors = [ "нет", "черный", "синий", "зеленый", "желтый", "красный", "белый"];
...
function(ext)
{
     ...
     var descriptor = {
     blocks: [
              ['w', 'двигаться %m.dualMotors %m.turnStyle %n секунд',         'steeringControl',  'B+C', 'forward', 3],
              [' ', 'включить мотор %m.whichMotorPort со скоростью %n',              'startMotors',      'B+C', 100],
              [' ', 'вращать двигатель %m.whichMotorPort со скоростью %n на %n град. затем %m.brakeCoast',              'motorDegrees',      'A', 100, 360, 'brake'],
              [' ', 'остановать все моторы %m.brakeCoast',                       'allMotorsOff',     'brake'],
              ['h', 'когда нажата кнопка Порт %m.whichInputPort',       'whenButtonPressed','1'],
              ['h', 'when IR remote %m.buttons pressed port %m.whichInputPort', 'whenRemoteButtonPressed','Top Left', '1'],
              ['R', 'нажата кнопка %m.whichInputPort',                    'readTouchSensorPort',   '1'],
              ['w', 'играть ноту %m.note duration %n мс',                    'playTone',         'C5', 500],
              ['w', 'играть частоту %n длительностью %n мс',                    'playFreq',         '262', 500],
              ['R', 'датчик освещения %m.whichInputPort %m.lightSensorMode',   'readColorSensorPort',   '1', 'color'],
              ['w', 'ждать пока датчик освещения %m.whichInputPort detects black line',   'waitUntilDarkLinePort',   '1'],
              ['R', 'дачтик расстояния %m.whichInputPort',                  'readDistanceSensorPort',   '1'],
              ['R', 'внешняя кнопка %m.whichInputPort',                     'readRemoteButtonPort',   '1'],
              ['R', 'гироскоп  %m.gyroMode %m.whichInputPort',                 'readGyroPort',  'angle', '1'],
              ['R', 'мотор %m.motorInputMode %m.whichMotorIndividual',     'readFromMotor',   'position', 'A'],
              
              ['R', 'заряд батареи',   'readBatteryLevel'],
     ...
     dualMotors:       ['A+D', 'B+C'],
     turnStyle:        ['вперед', 'назад', 'вправо', 'влево'],
     brakeCoast:       ['тормоз', 'накат'],
     lightSensorMode:  ['отражение', 'освещение', 'цвет'],
     motorInputMode: ['позиция', 'скорость'],
     gyroMode: ['угол', 'частота'],
